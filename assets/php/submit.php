...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="isaacpacheco.go@gmail.com";  // Your Mail
	$mail->Password="aiwj drzb jnel bwuu"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("isaacpacheco.go@gmail.com", "Issac Pacheco"); // (Your Mail) An email address that will receive the email with the output of the form
